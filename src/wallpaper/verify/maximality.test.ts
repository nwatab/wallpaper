...
const FILL: Record<string, WallpaperGroup> = {
  'test-p4m-girih': 'p4m',
  'test-p4-cracked-ice': 'p4',
  'test-p6m-shamsa': 'p6m',
  'test-pmm-leiwen': 'pmm',
  'test-p6-whirl': 'p6',
  'test-cmm-quatrefoil': 'cmm',
  'test-p4g-pinwheel': 'p4g',
  'test-p3-trefoil': 'p3',
  'test-p31m-medallion': 'p31m',
};

const MOTIF_OF: Record<string, string> = {
  'test-p4m-girih': 'p4m-girih-star',
  'test-p4-cracked-ice': 'p4-cracked-ice',
  'test-p6m-shamsa': 'p6m-shamsa',
  'test-pmm-leiwen': 'pmm-leiwen',
  'test-p6-whirl': 'p6-whirl',
  'test-cmm-quatrefoil': 'cmm-quatrefoil',
  'test-p4g-pinwheel': 'p4g-pinwheel',
  'test-p3-trefoil': 'p3-trefoil-knot',
  'test-p31m-medallion': 'p31m-medallion',
};
